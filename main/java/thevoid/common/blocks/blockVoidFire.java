...
public class blockVoidFire extends BlockFire
{
	...
	private static final String VF0 = "void:void_fire_0";
    private static final String VF1 = "void:void_fire_1";

    public blockVoidFire()
    {
        super();
    ...
    {
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.planks), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.double_wooden_slab), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.wooden_slab), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.fence), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.oak_stairs), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.birch_stairs), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.spruce_stairs), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.jungle_stairs), 5, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.log), 5, 5);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.log2), 5, 5);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.leaves), 30, 60);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.leaves2), 30, 60);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.bookshelf), 30, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.tnt), 15, 100);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.tallgrass), 60, 100);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.double_plant), 60, 100);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.yellow_flower), 60, 100);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.red_flower), 60, 100);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.wool), 30, 60);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.vine), 15, 100);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.coal_block), 5, 5);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.hay_block), 60, 20);
        ((blockVoidFire) TheVoid.voidFire).func_149842_a(getIdFromBlock(Blocks.carpet), 60, 20);
    }
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        {
            if (((blockVoidFire) TheVoid.voidFire).canCatchFire(p_149734_1_, p_149734_2_ - 1, p_149734_3_, p_149734_4_, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((blockVoidFire) TheVoid.voidFire).canCatchFire(p_149734_1_, p_149734_2_ + 1, p_149734_3_, p_149734_4_, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((blockVoidFire) TheVoid.voidFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((blockVoidFire) TheVoid.voidFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
            ...
            if (((blockVoidFire) TheVoid.voidFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ + 1, p_149734_4_, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();

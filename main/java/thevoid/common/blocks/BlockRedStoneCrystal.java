...
public class BlockRedStoneCrystal extends Block
{
    ...
    private void glow(World par1World, int par2, int par3, int par4)
    {
        ...
        if (this.blockIcon == TheVoid.redStoneCrystalOre)
        {
            par1World.setBlock(par2, par3, par4, TheVoid.redStoneCrystalGlowingOre);
        }
    }
    /**
    ...
    {
        if (this.blockIcon == TheVoid.redStoneCrystalGlowingOre)
        {
            par1World.setBlock(par2, par3, par4, TheVoid.redStoneCrystalOre);
        }
    }
    ...
    {
        return TheVoid.redStoneCrystal;
    }
    ...
    {
        return new ItemStack(TheVoid.redStoneCrystalOre);
    }
}

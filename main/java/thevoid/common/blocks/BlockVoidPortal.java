...
public class BlockVoidPortal extends BlockBreakable
{
    ...
    {
        BlockVoidPortal.Size size = new BlockVoidPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        BlockVoidPortal.Size size1 = new BlockVoidPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        BlockVoidPortal.Size size = new BlockVoidPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        BlockVoidPortal.Size size1 = new BlockVoidPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                this.field_150863_d = BlockVoidPortal.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = BlockVoidPortal.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[BlockVoidPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockVoidPortal.field_150001_a[this.field_150865_b][1]];
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[BlockVoidPortal.field_150001_a[this.field_150865_b][1]];
